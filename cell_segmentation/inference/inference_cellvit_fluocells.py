"""
CellViT Inference Method for Patch-Wise Inference on FNC dataset.
...
from cell_segmentation.datasets.fluocells import FluocellsDataset
...
class FluocellsInference:
    def __init__(
        ...
        """Cell Segmentation Inference class for Fluocells dataset
        ...
        self.inference_dataset = FluocellsDataset(
...
# CLI
class InferenceCellViTFluocellsParser:
    def __init__(self) -> None:
        parser = argparse.ArgumentParser(
            formatter_class=argparse.ArgumentDefaultsHelpFormatter,
            description="Perform CellViT inference for Fluocells dataset",
        )
        ...
        parser.add_argument(
            "--dataset",
            type=str,
            help="Path to Fluocells dataset.",
        )
        parser.add_argument(
            "--outdir",
            type=str,
...
if __name__ == "__main__":
    configuration_parser = InferenceCellViTFluocellsParser()
    configuration = configuration_parser.parse_arguments()
    print(configuration)

    inf = FluocellsInference(
