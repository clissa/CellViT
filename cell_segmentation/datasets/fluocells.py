...
Dataset information: <link-to-update>
Please Prepare Dataset as described here: docs/readmes/fluocells.md.
...
class FluocellsDataset(Dataset):
    def __init__(
        self,
        ...
        Args:
            ...
            patching (bool, optional): If patches with size 256px should be used Otherwise, the entire Fluocells images are loaded. Defaults to False.
    ...
    def set_transforms(self, transforms: Callable) -> None:
        """Set the transformations, can be used to exchange transformations
